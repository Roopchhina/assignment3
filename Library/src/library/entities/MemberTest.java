...
public class MemberTest {
	...
	public void setUp() throws Exception {
		mem1 = new Member("navinder", "Singh", "12345", "asmita@gmail.com", 101);
		mem2 = new Member("jagroop", "singh", "54321", "prateek@gmail.com", 102);
		mem3 = new Member("amritesh", "moudgil", "98765", "krishanthi@gmail.com", 103);
	...
	public final void testGetFirstName() {
		...
		assertEquals("Matching First Name", "atwal", fName);
	}
	...
	public final void testGetEmailAddress() {
		...
		assertEquals("Matching email", "atwal@gmail.com", email);
	}
